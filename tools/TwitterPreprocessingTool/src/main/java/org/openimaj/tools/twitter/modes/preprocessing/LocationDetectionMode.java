 ...
 * @author daniel
 */
public class LocationDetectionMode extends TwitterPreprocessingMode<Map<String, Object>> {
    ...
    public LocationDetectionMode() throws IOException {
        try {
    ...
    //}
    public Map<String, Object> process(USMFStatus twitterStatus) {
        String text=twitterStatus.text.trim().toLowerCase();
